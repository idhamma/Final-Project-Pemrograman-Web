...
<head>
    ...
    <section>
        <div class="textkategori">
            <h1>Cek Motor-Motor yang Kami Sediakan!</h1>
        </div>
        ...
        <div class="jeniscar">
            <div class="jenis-card">
                <h2>Motor Bebek</h2>
                <div class="garis"></div>
                <img src="image/motorpics/bebek.png" alt="bebek">
            ...
            <div class="jenis-card">
                <h2>Matic</h2>
                <div class="garis"></div>
                <img src="image/motorpics/automatic.png" alt="automatic">
            ...
            <div class="jenis-card">
                <h2>Off-road</h2>
                <div class="garis"></div>
                <img src="image/motorpics/offroad.png" alt="offroad">
            ...
            <div class="jenis-card">
                <h2>Sports</h2>
                <div class="garis"></div>
                <img src="image/motorpics/sports.png" alt="sports">
            ...
            <div class="jenis-card">
                <h2>Motor Gede</h2>
                <div class="garis"></div>
                <img src="image/motorpics/moge.png" alt="moge">
            ...
            <div class="jenis-card">
                <h2>Electric</h2>
                <div class="garis"></div>
                <img src="image/motorpics/electric.png" alt="electric">
